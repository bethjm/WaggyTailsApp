const DogQuiz = [
  {
    questionText: "Who is a great recourses for learning about dog behavior?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "You should not crate train a dog",
    ],
    correctAnswer:
      "It gives your dog a safe and quiet place to escape to when they feel overwhelmed or tired. Helps you know your dog is safe when you are not home. Help your travels safely with the dog. Helps with bowel control.",
  },
  ...
  },
  {
    ...
    options: [
      "Let the dog sort it out for themself",
      "Bring them to the local shelter and surrender",
  ...
  },
  {
    ...
    options: ["2 hours", "One hour for every month they are old", "4 hours"],
    correctAnswer: "One hour for every month they are old",
  },
  {
    questionText: "How long can a puppy/dog be left alone?",
    options: [
      "Puppies: 1-2 hours. Dogs: 8-12 hours",
      "Puppies: 4-6 hours. Dogs: 10-12 hours",
  ...
  },
  {
    ...
    options: ["2 hours per day", "30 minutes per day.", "15 minutes per day"],
    correctAnswer: "30 minutes per day.",
  },
  {
    questionText:
    ...
    options: [
      ...
      "Tell it to stop until it stops",
      "Lock the dog in it's crate until the excitment trigger is gone",
    ],
    correctAnswer:
      "Understand why your dog is jumping, they could be anxious or stressed. If they are excited: Train your dog to sit and stay when people enter through the door. Do not give the pup attention when they are jumping.",
  },
  ...
  },
  {
    ...
    options: [
      ...
      "Dogs do not need to go to the vet",
    ],
    correctAnswer:
      "On average once per year to update vaccinations and for preventative care.",
  },
  {
    ...
    options: [
      ...
      "So that they are better behaved",
      "Not all dogs need to be trained",
    ],
    correctAnswer:
      "It will improve relationship with your dog: it will trust you more. It keeps your dog safe. It improves your dogs confidence.",
  },
